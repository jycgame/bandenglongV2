...
cc.Class({
	...
	onLoad: function () {
        ...
        {
            var effect = this.node.getComponent(cc.Animation);
            if (this.dir.equals(cc.Vec2.RIGHT) || this.dir.equals(cc.Vec2.RIGHT.neg()))
                effect.play("bodyEffectHori");
            else if (this.dir.equals(cc.Vec2.UP) || this.dir.equals(cc.Vec2.UP.neg()))
                effect.play("bodyEffectVert");
        }
        this.setTex();
    },
        ...
        if (this.GameManager.speed != 0)
        {
            ...
            if (this.hasTarget) {
                ...
                if (nextDir.mag() != 0)
                {
                    ...
                    if (!this.refineNextDir(nextDir).equals(this.dir))//����߹���targetDist, ǿ���ƶ���targetDist
                    {
                        this.dir = this.dirQueue.shift();
                        this.setTex();

                        var restDist = this.TargetDist.sub(nextPos).mag();//�߹�targetDist�˶��پ���
