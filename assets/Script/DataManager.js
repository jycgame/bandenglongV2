        ...
        cc.loader.loadRes("Data/MonsterGameData", function (err, csvData) {
            if (err) {
                ...
                for (var i = 0; i < monsterData.length - 2; i++) {
                    ...
                    var monsterDataRow = [];
                    monsterDataRow[0] = monsterData[i + 2][1];//Ŀ��λ��
                    monsterDataRow[1] = monsterData[i + 2][2].split('-');//monster��ʵλ���б�
                    monsterDataRow[2] = monsterData[i + 2][3].split('-');//monster info�б�
                    monsterDataRow[3] = monsterData[i + 2][4];// �������÷�
